    ...
    <div class="row">
        <div class=".col-md-8 .offset-md-2">
            <table class="table table-hover table-bordered table-striped">
                ...
                <th style="vertical-align: middle;" class="text-center"><p style="color: red; font-size = 25px"><big>DİKKAT SADECE <big>5$</big> ÜSTÜ XMR YÜKLEMELERİNİZ HESABINIZA GEÇECEKTİR!!!</big></p></th>
            </table>
        </div>
    </div>
</div>
