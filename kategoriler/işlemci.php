...
<div class="album">
  <div class="container mt-4">
    ...
    <div class="mb-5">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="40" fill="currentColor" class="bi bi-cpu" viewBox="0 0 16 16">
          <path
    ...
    <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `products` WHERE categorie = 'processor'") or die('query failed');
