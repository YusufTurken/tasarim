...
if (isset($_SESSION['Kullanici'])){
    ...
    if(isset($_POST['buy'])){
        ...
        $KayıtSorgusu = $DBConnection->prepare("INSERT INTO orders (user_id, product_id, quantity, total_price, order_description) VALUES (?,?,?,?,?)");
        $KayıtSorgusu->execute([$KullaniciId, $fetch_cart['product_id'], $fetch_cart['quantity'], $total, $aciklama]);
